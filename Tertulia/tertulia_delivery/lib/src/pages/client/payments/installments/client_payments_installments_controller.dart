...
import 'package:tertulia_delivery/src/models/address.dart';
import 'package:tertulia_delivery/src/models/mercado_pago_card_token.dart';
import 'package:tertulia_delivery/src/models/mercado_pago_installment.dart';
import 'package:tertulia_delivery/src/models/mercado_pago_payment.dart';
import 'package:tertulia_delivery/src/models/mercado_pago_payment_method_installments.dart';
import 'package:tertulia_delivery/src/models/order.dart';
import 'package:tertulia_delivery/src/models/product.dart';
import 'package:tertulia_delivery/src/models/response_api.dart';
import 'package:tertulia_delivery/src/models/user.dart';
import 'package:tertulia_delivery/src/providers/mercado_pago_provider.dart';
  ...
  void createPayment() async {
    ...
    if (response.statusCode == 201) {
      ...
      if (response.body['error']['status'] == 400) {
        ...
        print('installments.value type: ${installments.value.runtimeType}');
      }
    }
