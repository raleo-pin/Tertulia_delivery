...
import 'package:tertulia_delivery/src/environment/environment.dart';
...
class ClientOrdersMapController extends GetxController {
  ...
  CameraPosition initialPosition = CameraPosition(
      target: LatLng(5.532445299334633, -73.3615978425328), zoom: 14);
  ...
  void updateLocation() async {
    try {
      ...
      animateCameraPosition(
          order.lat ?? 5.532445299334633, order.lng ?? -73.3615978425328);

      addMarker('delivery', order.lat ?? 5.532445299334633,
          order.lng ?? -73.3615978425328, 'Tu repartidor', '', deliveryMarker!);

      addMarker(
          'home',
          order.address?.lat ?? 5.532445299334633,
          order.address?.lng ?? -73.3615978425328,
          'Lugar de entrega',
          '',
          homeMarker!);
      ...
      LatLng from = LatLng(
          order.lat ?? 5.532445299334633, order.lng ?? -73.3615978425328);
      LatLng to = LatLng(order.address?.lat ?? 5.532445299334633,
          order.address?.lng ?? -73.3615978425328);
